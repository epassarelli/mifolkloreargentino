...
<head>
    ...
    <meta name="description" content="El Folklore Argentino en un solo lugar, biografías, interpretes, cartelera de eventos y letras de canciones">
...
<div class="row">     
  ...
  <div class="col-xs-12 col-sm-12 col-md-4 clearfix">
    <div class="thumbnail alert alert-danger" role="alert">
      
      <h1>404 - Página no encontrada</h1>

        <div class="caption">

            <p>La página que está intentando acceder no existe o es probable que haya cambiado de dirección.</p>
            <p>Te invitamos a que navegues nuestro sitio en busca de ella o bien que nos contactes a través del formulario de contacto de nuestro sitio.</p>
...
<div class="panel panel-default">
  <div class="panel-body">
	...
	<a class="btn btn-social-icon btn-twitter" href="https://twitter.com/intent/tweet?text=Mi Folklore Argentino - Grupos y Solistas, Festivales, Show, Letras&amp;url=http%3A%2F%2Fwww.mifolkloreargentino.com.ar%2F" onclick="window.open(_gaq.push(['_trackEvent', 'btn-social-icon', 'click', 'btn-twitter']);this.href, 'weeklywin', 'left=50,top=50,width=600,height=360,toolbar=0'); return false; ">
    ...
    <div class="copyright row">
        ...
        <div class="col-xs-12 col-sm-6">
            © <a href="#">Mi Folklore Argentino</a> 2018. Todos los derechos reservados. <br>
            Desarrollado por <a href="http://www.webpass.com.ar" target="_blank" rel="nofollow">WebPass</a>
        </div>
