...
public function index(){
	...
	if($this->ion_auth->in_group(1)){
		...
		{
			$data['filas'] = $this->Noticias_model->getNoticiasDeMisAdministrados($this->session->userdata('user_id'));
		}
...
public function nueva(){
	...
	{	
			...
			$data['files_css'] = array('bootstrap-chosen.css');
			$data['files_js'] = array('chosen.jquery.min.js');
			$data['breadcrumb'] = array(
							'Inicio' => base_url()
						);
