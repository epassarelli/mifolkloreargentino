...
<div class="box">
  ...
  <div class="box-header with-border">
    ...
    <div class="box-tools pull-right">
      <!-- <a class="btn btn-primary" href="<?php echo base_url();?>mipanel/administrados/administrar" role="button">Solicitar administrar uno existente</a> -->
      <a class="btn btn-success" href="<?php echo base_url();?>mipanel/administrados/nuevo" role="button"><i class="fa fa-plus"></i> Nuevo interprete</a>
