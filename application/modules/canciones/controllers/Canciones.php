...
class Canciones extends MX_Controller
{
	...
	public function index()
	{
		...
		$data['ultimas']   		= $this->Canciones_model->get_Ultimas(20);
		$data['xvisitas']   	= $this->Canciones_model->get_Ranking_Canciones(100);
	...
	public function mostrar($inte_alias, $canc_alias)
	{
		...
		$data['description']	= $data['cancion']->canc_titulo . ", letra de canción de " . $data['fila']->inte_nombre . ", " . $inicioLetra;
