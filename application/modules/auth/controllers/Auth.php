...
class Auth extends MX_Controller
{
	...
	function index(){
		if ($message = $this->session->flashdata('message')) {
			...
			//Esta linea la agregue yo para que todos los mensajes se muestren dentro del layout
			$data['message'] = $message;
			$data['view'] = 'auth/general_message';
			$data['sidebar_mid']    = 'auth_sidebar_mid_view';
			$data['sidebar']       	= 'auth_sidebar_view';
			$this->load->view('layout', $data);
			
			//$this->load->view('auth/general_message', array('message' => $message)); ### Esto era el default ###			
	...
	function login(){
		...
		if ($this->tank_auth->is_logged_in()) {									// logged in
			...
			$data['title'] 			= "Folklore Argentino";
			$data['description']	= "Folklore Argentino";
			$data['keywords']		= "Folklore Argentino";	
