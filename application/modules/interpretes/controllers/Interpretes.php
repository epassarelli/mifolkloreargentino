...
class Interpretes extends MX_Controller
{
	...
	{
		$data['title']      	= "Biografías de intérpretes del Folklore Argentino";
		$data['description']	= "Biografías e información de los artistas, músicos, cantores y cantantes que interpretan el repertorio del folklore argentino.";
		$data['keywords']   	= "biografias,artistas,compositores,interpretes,grupos,solistas,folklore,argentino,musica,cantores,abel pintos,horacio guarany, chaqueño palavecino,mercedes sosa,atahualpa yupanki,los nocheros,luciano pereyra,soledad pastorutti";
	...
	public function letra($letra)
	{
		...
		$data['breadcrumb'] = array(
			'Inicio' => base_url(),
			'Biografias de interpretes' => base_url() . 'interpretes'
		);
